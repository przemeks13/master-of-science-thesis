...
\begin{table}[htpb]
    ...
    display columns/0/.style={string type,column name={Lp.}, column type={r}},
    ...
    display columns/5/.style={string type,column name={Uwagi}}
    ]
...
\begin{table}[htpb]
    ...
    % display columns/3/.style={string type,column name={}}
    % display columns/4/.style={string type,column name={}}
    display columns/5/.style={string type, column type = p{5cm}, column name={Uwagi}}
    ]
