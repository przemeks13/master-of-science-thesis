...
\begin{table}[htbp]
  ...
  % every row 2/.style={before row={\rowcolor{YellowBar}}},
...
%
        ...
        \addplot table[x expr=\coordindex,y=jakość, col sep=comma]
...
Na podstawie Rys.\ref{fig:sensor_statistic} możena stwierdzić, że najwyższą wartość
