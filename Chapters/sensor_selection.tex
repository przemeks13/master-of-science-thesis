...
\indent Na podstawie rys.\ref{fig:sensor_statistic} można stwierdzić, że najwyższą wartość
 ...
 półfali sygnału. Nieco inaczej będzie to wyglądać w przypadku sygnału wyprostowanego
...
\indent Odnosząc się do czasu trwania sygnału jednoznacznie można stwierdzić, że im krótszy tym 
...
wychwycenia - będzie wymagać dużej częstotliwości przełączania układu bramkującego 
