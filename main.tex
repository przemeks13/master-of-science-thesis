...
\\[1cm]
\end{center} 
The thesis concerns testing piezoelectric transducers, that
...
\include{Chapters/assumptions}
\include{Chapters/exp_methods}
\include{Chapters/test_stand}
\include{Chapters/sensor_selection}
\include{Chapters/construction_optymization}
\include{Chapters/sensor_characteristic}
...
\include{Appendices/suplementA}
\include{Appendices/suplementB}
